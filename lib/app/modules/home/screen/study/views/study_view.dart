...
class StudyView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      initState: (state) {},
      builder: (controller) => CustomScrollViewStyle4(),
    );
  }
}

class CustomScrollViewStyle1 extends StatelessWidget {
  const CustomScrollViewStyle1({Key? key}) : super(key: key);
...
class CustomScrollViewStyle2 extends StatelessWidget {
  const CustomScrollViewStyle2({Key? key}) : super(key: key);
...
class CustomScrollViewStyle3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return CustomScrollView(
      slivers: <Widget>[
...
class CustomScrollViewStyle4 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return CustomScrollView(
      slivers: <Widget>[
